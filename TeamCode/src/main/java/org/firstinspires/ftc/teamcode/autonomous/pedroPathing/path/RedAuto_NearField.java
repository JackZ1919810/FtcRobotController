...
@Autonomous
@Configurable
public class RedAuto_NearField extends OpMode {
    ...
    public static class Paths {
        ...
        public Paths(Follower follower) {
            ...
            Path1 = follower
                    .pathBuilder()
                    .addPath(
                            new BezierLine(new Pose(123.000, 121.000), new Pose(160.000, 158.000))
                    )
            ...
            Path2 = follower
                    .pathBuilder()
                    .addPath(
                            new BezierLine(new Pose(160.000, 158.000), new Pose(144.000, 180.000))
                    )
                    .setConstantHeadingInterpolation(Math.toRadians(45))
                    .build();
//            Path2 = follower
